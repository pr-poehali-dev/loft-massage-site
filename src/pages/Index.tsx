...
export default function Index() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Комплексная проработка всего тела от головы до ног. Улучшает кровообращение, снимает мышечное напряжение и дарит чувство обновления. Вы почувствуете как каждая клеточка вашего тела наполняется энергией и жизненной силой',
      icon: 'User',
      prices: [
